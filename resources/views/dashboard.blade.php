            ...
            <div class="post d-flex flex-column-fluid" id="kt_post">
                               ...
                               <div class="row gy-5 g-xl-8">
                                   <div class="col-xl-4">
                                       ...
                                       <a href="{{_('careerList')}}" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                                           <!--begin::Body-->
                                           <div class="card-body">
                                               ...
                                               <!--end::Svg Icon-->
                                               <div class="text-inverse-danger fw-bolder fs-2 mb-2 mt-5">Employees List</div>
                                               <div class="fw-bold text-inverse-danger fs-7">View All</div>
                                           </div>
                                           <!--end::Body-->
                                       </a>
